const courses = [
    {
      ...
      images: [pic1, pic2, pic3], // Alternating images for each paragraph
      benefits: [
    ...
    },
    {
      ...
      images: [pic4, pic5, pic6], // Alternating images for each paragraph
      benefits: [
    ...
    },
    {
      ...
      images: [pic7, pic8, pic1], // Alternating images for each paragraph
      benefits: [
    ...
    },
    {
      ...
      images: [pic2, pic3, pic4], // Alternating images for each paragraph
      benefits: [
      ...
      rating: 4.6 // Star rating out of 5
    },
    {
      ...
      images: [pic5, pic6, pic7], // Alternating images for each paragraph
      benefits: [
      ...
      courseDuration: "4 Weeks (20 hours total)",
      rating: 4.9 // Star rating out of 5
    },
    {
      ...
      images: [pic3, pic4, pic5], // Alternating images for each paragraph
      benefits: [
      ...
      courseDuration: "3 Weeks (15 hours total)",
      rating: 4.4 // Star rating out of 5
    },
    {
      title: "Equity Market",
      overview: [
      ...
      images: [pic6, pic7, pic8], // Alternating images for each paragraph
      benefits: [
